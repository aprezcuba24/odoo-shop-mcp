...
from ...models.profile_put_body import ProfilePutBody
...
def sync_detailed(
    *,
    ...
    """Sustituir perfil (dirección completa)
    ...
    Returns:
        Response[ProfileResponse | SimpleErrorResponse | ValidationErrorResponse | UnauthorizedErrorResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        ProfileResponse | SimpleErrorResponse | ValidationErrorResponse | UnauthorizedErrorResponse
    """
