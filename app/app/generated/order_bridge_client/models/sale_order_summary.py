...
from ..models.sale_order_summary_delivery_status_type_0 import (
    SaleOrderSummaryDeliveryStatusType0,
)
from ..models.sale_order_summary_store_state import SaleOrderSummaryStoreState
...
T = TypeVar("T", bound="SaleOrderSummary")
...
class SaleOrderSummary:
    ...
    Attributes:
        ...
        origin (str):
        state (str):
        store_state (SaleOrderSummaryStoreState):
        currency (None | str | Unset):
        date_order (None | str | Unset):
        delivery_address (DeliveryAddressOut | None | Unset):
        delivery_status (None | SaleOrderSummaryDeliveryStatusType0 | Unset):
    ...
    delivery_status: None | SaleOrderSummaryDeliveryStatusType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.delivery_status, SaleOrderSummaryDeliveryStatusType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        store_state = SaleOrderSummaryStoreState(d.pop("store_state"))
        ...
        def _parse_delivery_status(
            data: object,
        ) -> None | SaleOrderSummaryDeliveryStatusType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                delivery_status_type_0 = SaleOrderSummaryDeliveryStatusType0(data)

                return delivery_status_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SaleOrderSummaryDeliveryStatusType0 | Unset, data)
