...
T = TypeVar("T", bound="ProductDetailResponse")
...
class ProductDetailResponse:
    ...
    Attributes:
        ...
        description_sale (None | str | Unset):
    ...
    description_sale: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        description_sale: None | str | Unset
        if isinstance(self.description_sale, Unset):
            description_sale = UNSET
        else:
        ...
        if description_sale is not UNSET:
            field_dict["description_sale"] = description_sale
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_description_sale(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        description_sale = _parse_description_sale(d.pop("description_sale", UNSET))
