...
@mcp.prompt(
    name="shop_assistant",
    description=(
        "Guía para ayudar al usuario a explorar el catálogo (vía resources yy-shop://catalog/...) "
...
def shop_assistant() -> list[Message]:
    lines = [
        ...
        "Para listar categorías o productos, lee los resources MCP del catálogo (yy-shop://catalog/...).",
